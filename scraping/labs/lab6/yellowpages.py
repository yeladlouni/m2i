...
class YellowPagesSpider(scrapy.Spider):
    name = 'yellowpages'
    start_urls = ['https://www.pagesjaunes.fr/annuaire/chercherlespros?quoiqui=pharmacie&ou=' + city for city in ['Paris', 'Toulouse', 'Lille', 'Lyon']]
    ...
    def parse(self, response):
        ...
        for company in companies:
            ...
            yield {'name': company_name.replace("\n", "")}
